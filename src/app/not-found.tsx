...
import MultiName from './components/multi-name';
	...
	return (
		<>
			...
			<div className="relative flex flex-col items-center bg-[#fddfa9] p-12 z-[100] min-h-[100vh] justify-center text-center">
				<h2 className="text-[3.25rem] script-font mb-[2rem] max-sm:mb-[4rem] leading-[1.2]">Can I offer you<br />an alternative?</h2>
				<div className="inline-flex max-sm:flex-col text-[150%] max-sm:gap-[1.5rem] sm:gap-[4rem]">
			...
			<div className="flex flex-col justify-center items-center relative min-h-[100vh] max-sm:min-h-[200vh] bg-black text-white overflow-hidden">
				...
				<div className="bg-black relative z-[3] pt-[2rem]">
					<Image
						...
						/>
					<div className="game-script text-[1.25rem] leading-[2] max-w-[600px]">
			...
			<div className="bg-[url(/bg/bg-red-room.webp)] bg-center bg-fixed flex flex-col justify-end items-center relative z-[3] min-h-[100vh] bg-black text-white">

			<div className="bg-[#8c1930] text-center text-[0.8rem] text-white py-[1.5rem] px-[5rem] rounded-t-[1.5rem]">
				<span className="">
        <Image aria-hidden
          src="the-cruzat-logo-w.svg"
          alt="The Cruzat"
          width="2266"
          height="546"
          className="h-auto max-w-[240px] sm:max-w-[240px] mb-[1rem]" />
        </span>
